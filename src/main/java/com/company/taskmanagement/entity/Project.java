...
public class Project {
    ...
    @Column(name = "DEFAUL_TASK_PRIORITY")
    ...
    public void setDefaultTaskPriority(TaskPriority defaulTaskPriority) {
        this.defaultTaskPriority = defaulTaskPriority == null ? null : defaulTaskPriority.getId();
    }
